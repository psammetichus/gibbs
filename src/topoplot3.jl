...
# ╔═╡ 413fe630-ac46-11ec-1074-6b0d85f264e0
begin
...
# ╔═╡ db5d9461-1204-4065-896f-4aff30d6af2a
EEG = matread("MATLAB_data_files/sampleEEGdata.mat")["EEG"];

# ╔═╡ 2e2c7e01-820e-4a17-ac44-b0ef75dd6b43
begin
	timeidx = 315
	trialidx = 10
	data = EEG["data"][:, timeidx, trialidx] #timepoint 315, from trial 10
	labels = EEG["chanlocs"]["labels"][:]
	# labels = [string(i) .* labels[i] for i in 1:64] # optional, if you want to append channel # with the channel label
...
# ╔═╡ abdb800a-e742-4463-a8c7-d3f7bdf7dad4
scatter(y, x, series_annotations = text.(labels, :bottom), marker_z=data, ms=10)

# ╔═╡ 3a8ec1d1-7f13-4126-9d53-3ad341294c8d
# interpolation code as per example on ScatteredInterpolation.jl documentation to create grid
begin
	n = 64 # to end up with 64x64 grid
...
# ╔═╡ 0965fd83-05b6-44bc-8cb3-09d350de0b66
contour(xrange, yrange, gridded) # note that data points are not in the same scale as the original data points.!
